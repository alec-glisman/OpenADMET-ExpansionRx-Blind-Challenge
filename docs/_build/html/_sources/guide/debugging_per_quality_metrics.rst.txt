...
- ``log_per_quality_metrics: true`` (correct)
- ``curriculum.enabled: true`` (correct)
- ``curriculum.qualities: [high, medium, low]`` (correct)
...
- Callback can be imported (correct)
- Callback can be instantiated with quality labels (correct)
- Callback computes and logs metrics correctly (correct)
- Configuration is correct (correct)
- MLflow is accessible (correct)
